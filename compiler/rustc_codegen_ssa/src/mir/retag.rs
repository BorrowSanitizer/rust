    ...
    fn for_value<Bx: BuilderMethods<'a, 'tcx>>(
        ...
        match layout.ty.kind() {
            ...
            _ => {
                ...
                let recurse = match bx.cx().sess().opts.unstable_opts.codegen_retag_fields {
                ...
                if recurse { Self::walk_value(bx, fx, layout, kind) } else { None }
            }
        }
    }
    ...
    for OperandRef<'tcx, Bx::Value>
{
    ...
    fn retag(
        ...
        let retagged_val = bx.retag_operand(pointer, size, perm, fn_entry, im_layout);
...
impl<'a, 'tcx, Bx: BuilderMethods<'a, 'tcx>> Retagable<'a, 'tcx, Bx> for PlaceRef<'tcx, Bx::Value> {
    ...
    fn retag(
        ...
        bx.retag_place(pointer, size, perm, fn_entry, im_layout);
        *self
    }
