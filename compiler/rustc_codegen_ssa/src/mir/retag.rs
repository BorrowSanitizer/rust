...
impl<'a, 'tcx, Bx: BuilderMethods<'a, 'tcx>> FunctionCx<'a, 'tcx, Bx> {
    /// Emits a retag for an operand local. This is special-cased to allow for more efficient retagging
    /// as a side-effect of assignment.
    ...
    /// directly to the operand. Otherwise, we need to retag the pointer stored within the place—an additional
