...
pub trait IntrinsicCallBuilderMethods<'tcx>: BackendTypes {
    ...
    fn retag_place(&mut self, place: Self::Value, size: Size, perm: u64, protected: bool);
    fn link_tag(&mut self, place: Self::Value, local: Local);
    fn consume_tag(&mut self, place: Self::Value, local: Local);
