...
options! {
    ...
    codegen_emit_retag: bool = (false, parse_bool, [TRACKED],
        "emit `__rust_retag` calls in generated code (default: no)"),
    codegen_emit_expose_tag: bool = (false, parse_bool, [TRACKED],
        "emit `__rust_expose_tag` calls in generated code (default: no)"),
