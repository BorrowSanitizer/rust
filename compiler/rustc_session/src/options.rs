...
options! {
    ...
    codegen_emit_retag: bool = (false, parse_bool, [TRACKED],
        "emit experimental retag intrinsic calls (e.g. `__rust_retag`) in generated code (default: no)"),
    codegen_retag_no_precise_pinning : bool = (false, parse_bool, [TRACKED],
        "track pinned data on the level of references instead of on the byte-level (default: false)"),
    ...
    llvm_emit_lifetime_markers: bool = (false, parse_bool, [TRACKED],
